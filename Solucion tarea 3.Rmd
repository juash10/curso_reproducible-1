...
setwd("C:/Users/JC/Desktop/curso_reproducible")
...
Objetivo: Graficar la proporción de falsos positivos según el n?mero de variables utilizado en la función de regresión escalonada.
...
Aquí se muestra el animal más hermoso del planeta, muy amenazado, no sólo directamente por la cacería sino también indirectamente por la pérdida de hábitat, principalmente causada por el rápido calentamiento global.
